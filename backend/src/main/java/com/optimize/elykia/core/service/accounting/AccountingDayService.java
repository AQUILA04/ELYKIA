...
public class AccountingDayService extends GenericService<AccountingDay, Long> {
    ...
    @Transactional
    public synchronized AccountingDay openAccountingDay() {
     ...
     */
    @Transactional
    public synchronized LocalDate ensureCurrentAccountingDay() {
        Optional<AccountingDay> openedDay = getRepository().findByStatus(AccountingDayStatus.OPENED);
    ...
    @Transactional
    public synchronized AccountingDay closeAccountingDay() {
