...
@RestController
@RequestMapping("/api/v1/customer-mobile-money-submissions")
@RequiredArgsConstructor
public class CustomerMobileMoneySubmissionAdminController {

    private final CustomerMobileMoneySubmissionAdminService adminService;
