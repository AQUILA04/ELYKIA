...
public class UserPermissionConstant {
    ...
    public static final String KPI_FINANCIER_DASHBOARD = "ROLE_KPI_FINANCIER_DASHBOARD";
    public static final String KPI_FINANCIER_RAPPORT_JOURNALIER = "ROLE_KPI_FINANCIER_RAPPORT_JOURNALIER";
    public static final String KPI_FINANCIER_TONTINE = "ROLE_KPI_FINANCIER_TONTINE";
    public static final String KPI_FINANCIER_TONTINE_COLLECTE = "ROLE_KPI_FINANCIER_TONTINE_COLLECTE";
    public static final String KPI_FINANCIER_TONTINE_LIVRAISON = "ROLE_KPI_FINANCIER_TONTINE_LIVRAISON";
    public static final String KPI_FINANCIER_TRANSFERT_VENTE = "ROLE_KPI_FINANCIER_TRANSFERT_VENTE";
    public static final String KPI_FINANCIER_BI_DASHBOARD = "ROLE_KPI_FINANCIER_BI_DASHBOARD";
    public static final String KPI_FINANCIER_BI_VENTES = "ROLE_KPI_FINANCIER_BI_VENTES";
    public static final String KPI_FINANCIER_BI_RECOUVREMENT = "ROLE_KPI_FINANCIER_BI_RECOUVREMENT";
    public static final String KPI_FINANCIER_BI_STOCK = "ROLE_KPI_FINANCIER_BI_STOCK";
    public static final String KPI_FINANCIER_DEPENSE = "ROLE_KPI_FINANCIER_DEPENSE";
