...
export class TontineCollecteService {
  private apiUrl = `${environment.apiUrl}/api/v1/tontine-collections/web`;

  constructor(private http: HttpClient) {}

  getCollectes(dateFrom: string, dateTo: string, collector?: string, page: number = 0, size: number = 500): Observable<any> {
