...
- **Générateur & RAG Index** : Compilation de l'ensemble des guides imprimables (`guide_complet_manager.md`, `guide_complet_commercial.md`, `guide_complet_storekeeper.md`) et mise à jour de l'index RAG IA (92 fragments) dans `backend/src/main/resources/ai/user-guide-index.json`.
